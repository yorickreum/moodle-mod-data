...
$string['headersingletemplateteacher'] = 'Defines browsing interface for a single entry for teachers';
...
$string['singleteacher'] = 'View teacher single';
$string['singletemplate'] = 'Single template';
$string['singletemplateteacher'] = 'Single template for teacher';
